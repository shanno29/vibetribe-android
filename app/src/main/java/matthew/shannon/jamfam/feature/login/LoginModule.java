...
public class LoginModule {
    ...
    @Provides
    @LoginScope
    LoginContract.Presenter presenter(LoginContract.View view, NetworkService network, CacheService cache, FlowService flow) {
        return new LoginPresenter(view, network, cache, flow);
