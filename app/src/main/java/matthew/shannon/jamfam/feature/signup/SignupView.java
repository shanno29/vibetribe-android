    ...
    protected void onResume() {
        ...
        SimpleTextWatcher signupWatcher = new SimpleTextWatcher(){
            ...
            @Override  public void afterTextChanged(Editable e) {
                if(e == binding.etEmailLayout.getEditText().getText()) StringUtils.empty(binding.etEmailLayout, "Email Is Blank");
                if(e == binding.etUsernameLayout.getEditText().getText()) StringUtils.empty(binding.etUsernameLayout, "Username Is Blank");
                if(e == binding.etFullNameLayout.getEditText().getText()) StringUtils.empty(binding.etFullNameLayout, "Full Name Is Blank");
                if(e == binding.etCityLayout.getEditText().getText()) StringUtils.empty(binding.etCityLayout, "City Is Blank");
                if(e == binding.etStateLayout.getEditText().getText()) StringUtils.empty(binding.etStateLayout, "State Is Blank");
                if(e == binding.etAgeLayout.getEditText().getText()) StringUtils.empty(binding.etAgeLayout, "Age Is Blank");
                if(e == binding.etGenderLayout.getEditText().getText()) StringUtils.empty(binding.etGenderLayout, "Gender Is Blank");
                if(e == binding.etPassOneLayout.getEditText().getText()) StringUtils.empty(binding.etPassOneLayout, "Password Is Blank");
                if(e == binding.etPassTwoLayout.getEditText().getText()) StringUtils.empty(binding.etPassTwoLayout, "Password Is Blank");
